...
foreach($_SESSION['cartItems'] as $cartId => $cartItem){
 ...
 <div class="dropdown-menu">
     <div class="row total-header-section">
         ...
         <i class="fa fa-shopping-cart" aria-hidden="true"></i> total: <span class="text-warning"><?=$cartTotalSum?> kr</span>
         ...
         <div class="col ">
             ...
             <div class="manage">
                 <form action="checkout.php" method="POST">
                     <input type="submit" name="" value="Checkout" class="btn btn-warning">
                 </form>
             </div>
         </div>
     </div>
