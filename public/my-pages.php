...
<div class="container emp-profile">
    <div class="row">
        ...
        <div class="col-md-2">
            <button type="button" class="btn logInBtn" data-toggle="modal" data-target="#updateUserModal" data-id="<?=htmlentities($userById['id'])?>" data-username="<?=htmlentities($userById['username'])?>" data-first_name="<?=htmlentities($userById['first_name'])?>" data-last_name="<?=htmlentities($userById['last_name'])?>" data-email="<?=htmlentities($userById['email'])?>" data-phone="<?=htmlentities($userById['phone'])?>" data-postal_code="<?=htmlentities($userById['postal_code'])?>" data-street="<?=htmlentities($userById['street'])?>" data-city="<?=htmlentities($userById['city'])?>" data-country="<?=htmlentities($userById['country'])?>">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="profile-work">
                <button type="button" class="btn logInBtn" data-toggle="modal" data-target="#updateUserPasswordModal" data-id="<?=htmlentities($userById['id'])?>" data-password="<?=htmlentities($userById['password'])?>" data-confirmPassword="<?=htmlentities($userById['confirmPassword'])?>">
                    Change password
                </button>
                <button type="button" class="btn logInBtn" data-toggle="modal" data-target="#updateUserImageModal" data-id="<?=htmlentities($userById['id'])?>" data-img_url="<?=htmlentities($userById['img_url'])?>">
                    Change image
                </button>
                <button type="button" class="btn logInBtn">
                    My orders
                ...
                <button type="button" class="btn logInBtn" data-toggle="modal" data-target="#deleteUserAccountModal" data-username="<?=htmlentities($userById['username'])?>" data-id="<?=htmlentities($_POST['id'])?>">
                    Delete my account
                </button>
            </div>
        </div>
...
<div class="modal fade" id="updateUserImageModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Update user Password</h5>
...
<div class="modal fade" id="deleteUserAccountModal" tabindex="-1" role="dialog" aria-labelledby="deleteUserLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
